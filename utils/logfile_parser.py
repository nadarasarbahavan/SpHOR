...
def parse_arpl_out_file(path, rx_dict, root_dir, save_name='test.pkl', save=True, verbose=True):
...
def parse_multiple_files(all_paths, rx_dict, root_dir, save_name='test.pkl', verbose=True, save=False):
