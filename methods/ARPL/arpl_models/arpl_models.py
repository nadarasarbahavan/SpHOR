...
class classifier32ABN(nn.Module):
    def __init__(self, num_classes=10, num_ABN=2, feat_dim=None, normalize=False):
        ...
        self.activationdip = 0.2
        print (" 32ABN but with relu",self.activationdip)
    ...
    def forward(self, x, return_feature=False, bn_label=None):
        ...
        x = nn.LeakyReLU(self.activationdip)(x)
        x = self.conv2(x)
